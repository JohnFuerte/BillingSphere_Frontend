...
class SALESPOSReceiptHalfPage extends StatefulWidget {
  const SALESPOSReceiptHalfPage({
    super.key,
    required this.sales,
  ...
  @override
  State<SALESPOSReceiptHalfPage> createState() =>
      _SALESPOSReceiptHalfPageState();
}

class _SALESPOSReceiptHalfPageState extends State<SALESPOSReceiptHalfPage> {
  ...
  Future<Uint8List> _generatePdf(PdfPageFormat format, String title) async {
    ...
    final customFormat = PdfPageFormat.a3.copyWith(
      marginLeft: 30,
      marginRight: 30,
      marginTop: 30,
      marginBottom: 30,
        ...
        build: (context) {
          return pw.Column(
            children: [
              ...
              //       children: [
              //         pw.Container(
              //           width: customFormat.width * 0.0001,
              //           height: 18,
