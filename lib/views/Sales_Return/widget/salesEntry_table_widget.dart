...
class SalesReturnTable extends StatefulWidget {
  ...
  @override
  State<SalesReturnTable> createState() => _SalesReturnTableState();
}

class _SalesReturnTableState extends State<SalesReturnTable> {
...
class SalesReturnEditTable extends StatefulWidget {
  const SalesReturnEditTable({
    super.key,
    required this.unitControllerP,
    required this.entryId,
    required this.itemNameControllerP,
  ...
  @override
  State<SalesReturnEditTable> createState() => _SalesReturnEditTableState();
}

class _SalesReturnEditTableState extends State<SalesReturnEditTable> {
  final TextEditingController itemNameController = TextEditingController();
  final TextEditingController qtyController = TextEditingController();
  final TextEditingController rateController = TextEditingController();
  final TextEditingController unitController = TextEditingController();
