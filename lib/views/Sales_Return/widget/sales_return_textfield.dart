...
class SalesReturnTextField extends StatefulWidget {
  const SalesReturnTextField({
    super.key,
    this.width,
    this.height,
    this.padding,
  ...
  @override
  State<SalesReturnTextField> createState() => _SalesReturnTextFieldState();
}

class _SalesReturnTextFieldState extends State<SalesReturnTextField> {
  @override
